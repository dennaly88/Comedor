<section class="signup-sectioness" id="signup">
    ...
    <br><?php require("cuerpo-potes-tabla.php"); ?>


</section>

<section class="contact-section bg-black"><br>
    <div class="container px-4 px-lg-5">
        <div class="row gx-4 gx-lg-5">
            ...
            <div class="col-md-4 mb-3 mb-md-0">
                <div class="card py-4 h-100">
                    <div class="card-body text-center">
                        ...
                        <h4 class="text-uppercase m-0">Extenciones</h4>
                        <hr class="my-4 mx-auto" />
...
<footer class="footer bg-black small text-center text-white-50">
    <div class="container px-4 px-lg-5">VTV &copy; Todos los Derechos Reservado Division de Desarrollo</div>
