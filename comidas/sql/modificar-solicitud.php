...
$query = "UPDATE solicitud SET id='$edit_id', usuario='$edit_usuario', gerencia='$edit_gerencia',tipo='$edit_tipo',solicitada='$edit_solicitada', hora='$edit_hora',fecha='$edit_fecha' ,accion='$edit_accion',entregado='$edit_entregado',observacion='$edit_observacion'
...
header("Location: http:../comidas.php?usu=2");
