    ...
    <div class="modal-dialog modal-login">
        <div class="modal-content">
            <div class="bg-dark modal-header text-white">
                <input class="btn-submit btn btn-primary btn-sm" type="submit" size="5" value="ELIMINAR SOLICITUD DE AGUA">


            </div>
            <div class="modal-body">
                <form action="sql/eliminar-gestionar.php?id=<?php echo $id; ?>" method="post">
                    <div class="modal-body">
                        <div class="card border mb-3" style="max-width: 50rem;">
                            <div class="card-body text-secondary">
                                <center>
                                    ...
                                    Solicitada<input type="text" class="form-control form-control-sm" name="password" value="<?php echo $row['solicitada']; ?>" placeholder="Solicitada" required="required">
