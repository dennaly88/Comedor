    ...
    <div class="modal-dialog modal-login">
        <div class="modal-content">
            <div class="bg-dark modal-header text-white">
                <input class="btn-submit btn btn-primary btn-sm" type="submit" size="5" value="Modificar la Solicitud de AGUA">
            ...
            <div class="modal-body">
                ...
                <div class="card border mb-3" style="max-width: 50rem;">
                    <div class="card-body text-secondary">
                        <center>
                            <form method="post" action="sql/modificar-gestionar.php?id=<?php echo $id; ?>">
                                ...
                                Entregada<input class="form-control form-control-sm" type="text" id="edit_entregada" name="edit_entregada" value="" required>
...
?>" required>
                                ...
                                Fecha<input class="form-control form-control-sm" type="text" name="edit_fecha" id="edit_fecha" placeholder="" value="<?php echo $row['fecha']; ?>" required readonly>
