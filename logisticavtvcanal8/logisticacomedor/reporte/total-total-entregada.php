...
$query = "SELECT * FROM solicitud where accion='Entregada' and  fecha ='$fecha'";
...
while ($mostrar = pg_fetch_array($result)) {
    ...
    $pdf->Cell(16, 10, $mostrar['entregada'], 1, 0, 'C', 0);
    $total +=  $mostrar['entregada'];
    $pdf->Cell(22, 10, $mostrar['accion'], 1, 0, 'C', 0);
