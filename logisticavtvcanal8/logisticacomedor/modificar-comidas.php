            ...
            <div class="modal-body">
                ...
                <div class="card border mb-3" style="max-width: 50rem;">
                    <div class="card-body text-secondary">
                        <center>
                            <form method="post" action="sql/modificar-solicitud.php?id=<?php echo $id; ?>">
                                ...
                                Hora<input class="form-control form-control-sm" type="text" name="edit_hora" id="edit_hora" placeholder="" readonly value=" <?php
                                ...
                                Fecha<input class="form-control form-control-sm" type="text" name="edit_fecha" id="edit_fecha" placeholder="" readonly value="  <?php
                                ...
                                Accion<input class="form-control form-control-sm" type="text" name="edit_accion" id="edit_accion" placeholder="" readonly value="<?php echo $row['accion']; ?>" required><br>
                                Entregado A <input class="form-control form-control-sm" type="text" name="edit_entregado" id="edit_entregado" readonly placeholder="" value="<?php echo $row['entregado']; ?>">
                    </div>
                </div>
            </div>
