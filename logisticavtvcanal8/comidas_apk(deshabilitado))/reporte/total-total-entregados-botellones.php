...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(195, 10, 'TOTAL ENTREGADAS', 1, 1, 'C');

        $this->Cell(22, 10, 'Fecha', 1, 0, 'C', 0);
        $this->Cell(48, 10, 'Gerencia', 1, 0, 'C', 0);
        $this->Cell(25, 10, 'Entregadas', 1, 0, 'C', 0);
...
$query = "SELECT * FROM botellon where  accion='Entregada' ";
...
while ($mostrar = pg_fetch_array($result)) {
    ...
    $pdf->Cell(25, 10, $mostrar['entregada'], 1, 0, 'C', 0);
    $pdf->Cell(22, 10, $mostrar['usuario'], 1, 0, 'C', 0);

    $total +=  $mostrar['entregada'];
