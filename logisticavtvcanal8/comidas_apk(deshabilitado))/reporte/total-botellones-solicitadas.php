...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Ln(20);
        $this->Cell(195, 10, 'CONTROL DE BOTELLONES', 1, 1, 'C');
        $this->Cell(195, 10, 'TOTAL SOLICITADAS', 1, 1, 'C');

        $this->Cell(22, 10, 'Fecha', 1, 0, 'C', 0);
        $this->Cell(48, 10, 'Gerencia', 1, 0, 'C', 0);
        $this->Cell(25, 10, 'Solicitada', 1, 0, 'C', 0);
        $this->Cell(22, 10, 'Usuario', 1, 0, 'C', 0);

        $this->Cell(38, 10, 'Estado', 1, 0, 'C', 0);
...
$query = "SELECT * FROM botellon where  accion='Solicitud' and '$gerencia'=gerencia";
...
while ($mostrar = pg_fetch_array($result)) {
    ...
    $pdf->Cell(25, 10, $mostrar['solicitada'], 1, 0, 'C', 0);
    $pdf->Cell(22, 10, $mostrar['usuario'], 1, 0, 'C', 0);

    $total +=  $mostrar['solicitada'];
    $pdf->Cell(38, 10, $mostrar['accion'], 1, 0, 'C', 0);
