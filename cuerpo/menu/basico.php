...
<nav class="navbar navbar-expand-md navbar-white   sticky-top">
      ...
      <div class=" collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav mx-auto">
                  ...
                  <button class="mr-3 btn btn-info btn-sm" onclick="location.href='principal-solicitud.php'">Comidas</button>
                  <button class="mr-3 btn btn-info btn-sm" onclick="location.href='principal-botellones.php'">Botellon</button>

                  <a href="calculadora.php" target="_blank" onclick="window.open(this.href, this.target, 'width=500,height=100'); return false;">
