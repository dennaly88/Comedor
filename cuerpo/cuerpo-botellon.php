  ...
  <center>
    <div class="card border-secondary mb-3" style="max-width: 80rem;">
      <div class="card-header card text-white bg-secondary mb-3">
        ...
        <center><button type="button" class="btn-close btn btn-info btn-sm" data-dismiss="modal" onclick="location.href='principal-botellones.php'" style="max-width: 10rem;">
            <span aria-hidden="true" class="text-light">Solicitud de Botellones</span>
          </button>
      ...
      <div class="card-body text-secondary">
        ...
        <table id="p" class="table active border-secondary responsive" style="max-width: 80rem" ;>
          ...
          $usuario = $_SESSION['botellon'];



          $query1 = "SELECT gerencia FROM botellon WHERE gerencia ='$botellones'";
          ...
          $gerencia = $_SESSION['botellones'];

          ?>


          <?php
          //$query = 'SELECT * FROM  botellon ';
          $query = 'SELECT * FROM  botellon   ';
                  ...
                  <center>
                    ...
                    <center>
                                              ...
                                              <center>
                                                ...
                                                <center>
                                                  ...
                                                  <td>
                                                    ...
                                                    <a href="principal-eliminar-botellon.php?id=<?php echo $id; ?>">
                     ...
                     data-usu=" <?php echo $usu; ?>" data-pass="<?php echo $pass; ?>" data-per="<?php echo $per; ?>" data-cor="<?php echo $cor; ?>" data-nom="<?php echo $nom; ?>" data-ape="<?php echo $ape; ?>" data-tel="<?php echo $tel; ?>" data-ced="<?php echo $ced; ?>">
                                                        ...
                                                        <a href="principal-editar-botellon.php?id=<?php echo $id; ?>">
        ...
        <div class="modal-content">
          ...
          <div class="modal-header btn btn-secondary mb-3">
            <button type="button" class="btn-close btn btn-info btn-sm" data-dismiss="modal">
              <span aria-hidden="true">Crear Solicitud de Botellon</span>
          </div>
          <div class="modal-body">
            <div class="card border mb-3" style="max-width: 50rem;">
              <div class="card-body text-secondary">
