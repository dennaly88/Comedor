...
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
         ...
         <center>
          ...
          <div class="card-body text-secondary"> 
            <!-- ______________________________________CREAR___________________________________________________-->
...
<!--_____________________________________BOTON EDITAR_________________________________________________________________-->
                       ...
                       <!-- ______________________________________________AUMENTAR __________________________________________-->
                       ...
                       <!-- _________________________________________DISMINUIR__________________________________________________-->
           ...
           <center>
            <form method="post"  action="sql/crear-viveres.php">
                      ...
                      <div class="form-group">
                        ...
                        Fecha<input class="form-control form-control-sm" type="text" name="fecha" id="fecha" placeholder="" value="<?php echo  date("d-m-Y");?>" required >
