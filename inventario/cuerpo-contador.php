...
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
         ...
         <center>
          ...
          <div class="card-body text-secondary"> 
              <button type="button" title="Crear" class="btn btn-info btn-sm" data-toggle="modal" data-target="#ex1" data-whatever="">&#x2795;</button>
...
<!--___________________________BOTON ELIMINAR_________________________________________________________________________-->
 ...
 <a href="principal-eliminar-harina.php?id=<?php echo $id;?>"> 
...
<!--_____________________________________BOTON EDITAR_________________________________________________________________-->
                       <a href="principal-editar-harinas.php?id=<?php echo $id;?>"> 
                       <button type= 'button' class= 'btn btn-info btn-sm'  title="Editar"> &#x1f4dd; </button>   

                       
<!--_____________________________________BOTON AUMENTAR Y DISMINUIR_________________________________________________________________-->                    
      <a href="principal-aum-harina.php?id=<?php echo $id;?>"> 
      
      <button type= 'button' class= 'btn btn-success btn-sm'  title="Aumentar"> &#x2795; </button>


      <a href="principal-dim-harina.php?id=<?php echo $id;?>"> 
...
<script type="text/javascript" charset="utf8" src="js/jquery.dataTables.js"></script>
      ...
      <div class="modal fade " id="ex1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog  mb-3" role="document">
                <div class="modal-content">
<!--___________________________________________________CABEZERA DEL MODAL________________________________________________________________________________________-->
                  <div class="modal-header btn btn-secondary mb-3">
                  ...
                  <span aria-hidden="true">Agregar Producto</span>
                              ...
                              <div class="modal-body">
                                <div class="card border mb-3" style="max-width: 50rem;">
                                 <div class="card-body text-secondary">
                                          <center>
                                         <form method="post"  action="sql/crear-harina.php">
                                              <?php     
                                                
                                                          $query = "SELECT * FROM tipo_viveres where nombre='Harina Pan' ";
                                                          $resulatdo = pg_query($query) or die ("error ");
                                                          $numReg = pg_num_rows($resulatdo);
                                                ?>
                                                      <div class="form-group">
                                      ...
                                      <?php     
                                        $query = "SELECT * FROM unidad where nombre = 'Kilos' ";
                                        $resulatdo = pg_query($query) or die ("error ");
                                        $numReg = pg_num_rows($resulatdo);
                                      ?>
                                        ...
                                        Cantidad<input class="form-control form-control-sm" type="number" name="cantidad" id="cantidad" placeholder=""  value="" required >
                                        Usuario<br><input class="form-control form-control-sm" type="text"  readonly name="usuario" id="usuario" readonly placeholder="" value="<?php echo  " " . $_SESSION['usuario']; ?>" required >
                                        Fecha<input class="form-control form-control-sm" type="text" readonly name="fecha" id="fecha" readonly  placeholder="" value="<?php echo  date("d-m-Y");?>" required >
                                        Accion<input class="form-control form-control-sm" type="text" readonly  name="accion" id="accion" readonly  placeholder="" value="Entrada" required >                            
           </div> 
      </div>
    </div>
            <div class="modal-footer btn btn-secondary">
