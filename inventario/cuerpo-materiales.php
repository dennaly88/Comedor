...
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
         ...
         <center>
          ...
          <!--___________________________BOTON CREAR_________________________________________________________________________-->
...
<!--_____________________________________BOTON AUMENTAR_________________________________________________________________-->   
<a href="principal-aum-materiales.php?id=<?php echo $id;?>">   
<button type= 'button' class= 'btn btn-success btn-sm'  title="Aumentar"> &#x2795; </button>


<!--_____________________________________BOTON DISMINUIR_________________________________________________________________-->
